...
def parse_args():
    ...
    parser.add_argument('--n-history', type=int, default=3,
                      help='Number of historical time points to condition on')
...
def main():
    ...
    print(f"Using {args.n_history} historical points for conditioning")
    print(f"Predicting {len(t_vals_days) - args.n_history} future points")
